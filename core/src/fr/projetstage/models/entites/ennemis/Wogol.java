...
public class Wogol extends Ennemi {

    /**
     * Constructeur d'un Wogol
    ...
    public Wogol(GameWorld world, Vector2 position, Type type) {
        ...
        idleAnimation = new Animation(TextureFactory.getInstance().getWogolIdleSpriteSheet(),4,0.5f);
        runningAnimation = new Animation(TextureFactory.getInstance().getWogolRunSpriteSheet(),4,0.5f);
