...
public class Dague extends Projectile{
     ...
     */
    public Dague(GameWorld world, Vector2 position, float largeur, float hauteur, Orientation direction){
    ...
    public void draw(SpriteBatch spriteBatch, float x, float y) {
        spriteBatch.draw(TextureFactory.getInstance().getDague(), x + body.getPosition().x, y + body.getPosition().y, 1/2f, 1/2f, 1, 1,
